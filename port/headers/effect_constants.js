...
/**
 * Effect status bit flags mirrored from the C++ engine.
 * @type {{EFFECT_STATUS_AVAILABLE: number, EFFECT_STATUS_SUMMON_SELF: number}}
 */
...
/**
 * Count limit categories used to scope once-per-X restrictions.
 * @type {{EFFECT_COUNT_CODE_OATH: number, EFFECT_COUNT_CODE_DUEL: number, EFFECT_COUNT_CODE_SINGLE: number, EFFECT_COUNT_CODE_CHAIN: number}}
 */
...
/**
 * Reset flags describing when an effect expires.
 */
...
/**
 * Primary effect flags defining scopes and behaviors.
 */
...
/**
 * Secondary effect flags used for niche checks.
 */
...
/**
 * Comprehensive list of effect codes mirrored from the engine.
 */
...
/**
 * Effect event identifiers describing hook points in the duel flow.
 */
